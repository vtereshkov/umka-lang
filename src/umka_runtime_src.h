...
"        case ^[]int8:  data, length = &bytes[0], len(bytes^)\n"
"        case ^[]uint8: data, length = &bytes[0], len(bytes^)\n"
"        case ^[]char:  data, length = &bytes[0], len(bytes^)\n"
"        default:\n"
"            if selfhasptr(buf) {\n"
"                return 0, stderror(.ptr)\n"
"            }\n"
"            data, length = buf.__self, sizeofself(buf)\n"
"    }\n"
